...
public class DocuportConstants {
    ...
    public static final String GOOGLE_CORRECT_ENTRACE_PAGE = "https://www.googleapis.com/oauth2/v4/token";
    public static final String CORRECT_TITLE = "Google";  // Ожидаемый заголовок
